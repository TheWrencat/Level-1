...
private void makeAlbum() {
	...
	images.put(new Integer(KeyEvent.VK_LEFT), "sushi.png"); // the chopstick will be connected to the LEFT key
	images.put(new Integer(KeyEvent.VK_RIGHT), "hp1-steak.png");
