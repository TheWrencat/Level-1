...
public class Jeopardy implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(buttonPressed==firstButton){
			...
			askQuestion("Jeopardy", "What game is this?", 200);
	...
	if(buttonPressed==secondButton){
			...
			askQuestion("Java", "What program was this game made with?", 400);
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		String ask = JOptionPane.showInputDialog(question);
		...
		if(ask.equals(correctAnswer)){
			...
			JOptionPane.showInternalMessageDialog(null, "The correct answer is: "+correctAnswer );
			// Call the updateScore() method
			updateScore();
		}
	}
